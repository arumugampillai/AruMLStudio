...
_SCHEMA_PATH = os.path.join(_CHART_DIR, "static", "ml_schema_registry.json")
_LEGACY_FEATURE_REGISTRY_PATH = os.path.join(_CHART_DIR, "static", "ml_feature_registry.json")
